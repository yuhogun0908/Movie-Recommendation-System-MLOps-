...
"""
CONTAINER1_IP ="172.17.0.3" 
CONTAINER1_PORT = "30010"
CONTAINER2_IP ="172.17.0.3" 
CONTAINER2_PORT = "30011"
"""
#"""
CONTAINER1_IP ="172.17.0.1" 
CONTAINER1_PORT = "7074"
CONTAINER2_IP ="172.17.0.1" 
CONTAINER2_PORT = "7075"
#"""
...
def recommend(userid):
    ...
    A_server_up = checkHealth(CONTAINER1_IP+" "+CONTAINER1_PORT)
    B_server_up = checkHealth(CONTAINER2_IP+" "+CONTAINER2_PORT)
    ...
    if not B_server_up and A_server_up:
        #print('1')
        #address = "http://"+CONTAINER1_IP+":"+CONTAINER1_PORT+"/recommend/"
        response_a = requests.get('http://172.17.0.3:30010/recommend/{}'.format(request_userid))
        #response_a = requests.get("http://172.17.0.1:7074/recommend/{}".format(request_userid))
        ...
        response_a = requests.get("http://172.17.0.1:7075/recommend/{}".format(request_userid))
        response = response_a.text
