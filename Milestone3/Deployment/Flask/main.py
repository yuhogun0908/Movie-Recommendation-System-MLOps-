...
CORPUS_dir_path = "/home/team24/milestone2/group-project-s22-k-avengers/Milestone2/model_pipeline/DB/CORPUS"

latest_file_path = osp.join(CORPUS_dir_path, "latest_info.json")
with open(latest_file_path, "r") as f:
    dir_name = json.load(f)["latest_path"]

data_dir = osp.join(CORPUS_dir_path, dir_name)

#data_dir = '/home/team24/milestone2/group-project-s22-k-avengers/Milestone2/Pipeline/Flask/large_data'  #large datasets
...
if model_mode == 0:
    ...
    trained_MF_path = "/home/team24/milestone2/group-project-s22-k-avengers/Milestone2/Pipeline/Flask/trained_MF/model_save"
...
#============================================Cold Starter========================================#
coldstarter_rootpath = '/home/team24/milestone2/group-project-s22-k-avengers/Milestone2/Pipeline/Flask/coldstarter_metadata'
...
def recommend(userid):
    ...
    try:
        ...
        if not newuser_flag:
            if model_mode == 0:
                with open("/home/team24/milestone2/group-project-s22-k-avengers/Milestone2/Pipeline/Flask/trained_MF/update_flag.json", 'r') as read_file:
                    update_flag = json.load(read_file)
                read_file.close()
                
                if update_flag['model_update']:
                    print('Loading... Model has been updated')
                    shutil.move("/home/team24/milestone2/group-project-s22-k-avengers/Milestone2/Pipeline/Flask/trained_MF/model_update/dump_file", "/home/team24/milestone2/group-project-s22-k-avengers/Milestone2/Pipeline/Flask/trained_MF/model_save/dump_file2")
                    update_flag['model_update']= int(0)
                        
                    with open('/home/team24/milestone2/group-project-s22-k-avengers/Milestone2/Pipeline/Flask/trained_MF/update_flag.json', 'w') as write_file:
                        json.dump(update_flag, write_file, ensure_ascii=False, indent = '\t')
                    write_file.close()
