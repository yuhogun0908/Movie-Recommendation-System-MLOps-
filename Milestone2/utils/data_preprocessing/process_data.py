...
def save_data(args, rating_matrix, user_idx2id, user_id2idx, movie_idx2id, movie_id2idx):
    print("  >> Wait.... ")
    date_string = datetime.now().strftime('%Y%m%d_%H%M')
    #dir_path = os.path.join(os.getcwd(), os.path.join(args.save_path, date_string))
    # TODO: save datafile considering the data versioning issue
    #           by storing it into the directory named as the time it has made
    dir_path = osp.join(get_project_root(), osp.join(args.save_path, date_string))
