...
class deployment_process():
    ...
    def recomm_movie_by_surprise(self, userId, unseen_movies, top_n=20):
    ...
    def get_unseen_surprise(self, ratings, userID, total_movies):
...
if __name__ == "__main__":
    ...
    dp_class.recommend(test_userID=int("100027"), top_n=20)