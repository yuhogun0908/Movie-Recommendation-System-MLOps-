...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--save_movie', type = int, default=True , help= 'If want to save {movieID}.csv, True')
    parser.add_argument('-u', '--save_user', type = int, default=True, help= 'If want to save {userID},csvm True')
    parser.add_argument('-r', '--save_request', type=int, default=False, help= 'If want to save {request},csvm True')
